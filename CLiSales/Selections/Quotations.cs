...
namespace CLiSales.Selections
{
    public class Quotations
    {
        ...
        public List<Quotations> GetList(string DB,Guid? Key)
        {
            List<Quotations> items = new List<Quotations>();
            string selQuery = "select top 100 percent * from dbo.fnSalesSelection_Quotations(@Key) order by [InvoiceDate] desc";
