...
namespace CLiSales.Selections
{
    public class Proforma
    {
        ...
        public List<Proforma> GetList(string DB,Guid? Key)
        {
            List<Proforma> items = new List<Proforma>();
            string selQuery = "select top 100 percent * from dbo.fnSalesSelection_Proforma(@Key) order by [InvoiceDate] desc";
