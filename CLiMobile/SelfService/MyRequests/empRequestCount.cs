...
namespace CLiMobile.SelfService.MyRequests
{
    public class MyRequestCount
    {
        ...
        public MyRequestCount GetItem(string DB,Guid? Key)
        {
            MyRequestCount item = new MyRequestCount();
            string selQuery = "select top 100 percent * from dbo.fnAppSelfService_EmployeeRequestCount(@Key) ";
