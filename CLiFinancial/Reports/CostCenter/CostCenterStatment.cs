...
{
    public class CostCenterStatment
    {
        ...
        public List<CostCenterStatment> GetList(string DB,Guid? Key,DateTime? FirstDate,DateTime? LastDate)
        {
            decimal Balance = 0;
            List<CostCenterStatment> items = new List<CostCenterStatment>();
            ...
            using (SqlConnection con = new SqlConnection(iCore.GetCon(DB)))
            {
                ...
                while (reader.Read())
                {
                    CostCenterStatment item = new CostCenterStatment();
