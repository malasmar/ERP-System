        ...
        $(element.getAttribute("data-ajax-update")).each(function (i, update)
        {
            ...
            switch (mode)
            {
                ...
                default:
                    ...
                    //alert($($.parseHTML(data)).find('#px-script').text());
                    //$(update).append('<script>' + $($.parseHTML(data)).find('#px-script').text() + '</script>');
                    //  $(update).html($.parseHTML(data));

                    //var $result = $.parseHTML(data, true);
                    //var $scripts = $result.find("script").add($result.filter("script")).detach();

                    //$(update).append($scripts);
                    //$(update).html($result);
