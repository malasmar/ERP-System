...
namespace CLiDashboard.Financial
{
    public class CurrentAccountBalance
    {
        ...
        public CurrentAccountBalance GetList(string DB)
        {
            CurrentAccountBalance item = new CurrentAccountBalance();
            string selQuery = "select top 100 percent * from dbo.fnDashFinancial_CurrentAccountBalance()  ";
