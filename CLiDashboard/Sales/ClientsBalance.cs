...
namespace CLiDashboard.Sales
{
    public class ClientsBalance
    {
        ...
        public ClientsBalance GetList(string DB)
        {
            ClientsBalance item = new ClientsBalance();
            string selQuery = "select top 100 percent * from dbo.fnDashSales_ClientsBalance()  ";
